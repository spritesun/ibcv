...
'strSQL = "alter table activities ALTER column [time] TEXT(255)"
...
'strSQL = "CREATE TABLE activities ([ID_no] AUTOINCREMENT, [name] TEXT(255), [date] TEXT(255), [time] TEXT(255), [venue] TEXT(255), [content] MEMO);"
